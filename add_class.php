...
<div id="" class="muted pull-left">
    <h4><i class="icon-plus-sign"></i> Add class</h4></div>
</div>
...
<div class="controls">
    <?php
    $query = mysqli_query($con,"select * from year order by year DESC");
    $row = mysqli_fetch_array($query);
    ?>
    <input id="" class="span5" type="text" class="" name="year" value="<?php  echo $row['year']; ?>" >
</div>
</div>
<div class="control-group">
<div class="controls">
