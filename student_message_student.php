...
<body>
    ...
    <script>
        ...
        <?php
        $query_announcement = mysqli_query($con,"select * from message LEFT JOIN student ON student.student_id = message.sender_id where  message.reciever_id = '$session_id' order by date_sended DESC")or die(mysqli_error($con));
