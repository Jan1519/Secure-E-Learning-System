...
<?php $get_id = $_GET['id']; ?>
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="#">Year: <?php echo $class_row['year']; ?></a> <span class="divider">/</span></li>
    ...
    <?php $query = mysqli_query($con,"select * FROM class_quiz LEFT JOIN quiz on class_quiz.quiz_id = quiz.quiz_id "
            . "where teacher_class_id = '$get_id'  ")or die(mysqli_error($con));
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table" id="">
        ...
        <tbody>
        <?php
        $query = mysqli_query($con,"select * FROM class_quiz LEFT JOIN quiz on class_quiz.quiz_id = quiz.quiz_id
        ...
        ?>                              
            <tr>                     
                ...
                <td width="200">
                <?php if ($grade == ""){ ?>
                <a data-placement="bottom" title="Take This Quiz" id="<?php echo $id; ?>Download" href="take_test.php
                    <?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&
                    <?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'quiz_time='.$quiz_time;?>">
