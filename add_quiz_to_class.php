    ...
    <?php include('navbar_teacher.php'); ?>
		...
		<table class="table" id="question">
                    ...
                    <tbody>
                        <?php $query = mysqli_query($con,"select * from teacher_class
                            ...
                            where teacher_id = '$session_id' and year = '$year' ")or die(mysqli_error($con));
		...
		<div class="control-group">
                <div class="controls">
                    ...
                    for($i=0; $i < $N; $i++)
                    {
                        mysqli_query($con,"insert into class_quiz (teacher_class_id,quiz_time,quiz_id) values('$id[$i]','$time','$quiz_id')")or die(mysqli_error($con));
