<form id="login_form1" class="form-signin" method="post"><br>
    <h3 class="form-signin-heading"><i class="icon-lock"></i>&nbsp;&nbsp;&nbsp; Sign in</h3><br>
        <input type="text" class="input-block-level" id="username" name="username" placeholder="Username" required>
        <input type="password" class="input-block-level" id="password" name="password" placeholder="Password" required>
        <center><button data-placement="right" title="Click Here to Sign In" id="signin" name="login" class="btn btn-info" type="submit"><i class="icon-signin icon-large"></i> Sign in</button></center>
