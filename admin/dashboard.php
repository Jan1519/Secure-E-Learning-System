	...
	<?php include('navbar.php') ?>
		...
		<?php include('sidebar_dashboard.php'); ?>
                ...
                <div class="span9" id="content">
                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <?php 
				$query_reg_teacher = mysqli_query($con,"select * from teacher where teacher_status = 'Registered' ")or die(mysqli_error($con));
				...
				?>
        			...
        			<?php 
				$query_file = mysqli_query($con,"select * from department")or die(mysqli_error($con));
