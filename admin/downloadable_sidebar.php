...
<ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
    ...
    <li class="active"><a href="downloadable.php"><i class="icon-chevron-right"></i><i class="icon-download"></i> Downloadable Materials</a></li>
    <li><a href="assignment.php"><i class="icon-chevron-right"></i><i class="icon-upload"></i> Uploaded Assignments</a></li>
    <li><a href="year.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Year</a></li>
    <li class=""><a href="calendar_of_events.php"><i class="icon-chevron-right"></i><i class="icon-calendar"></i>Calendar of Events</a></li>
</ul>
</div>