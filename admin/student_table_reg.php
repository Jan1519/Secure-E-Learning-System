<?php include('dbcon.php'); ?>
	...
	<?php include('modal_delete.php'); ?>
		...
		<tr>
            ...
            <?php
            $query = mysqli_query($con,"select * from student LEFT JOIN class ON student.class_id = class.class_id where status = 'Registered' ORDER BY student.student_id DESC") or die(mysqli_error($con));
