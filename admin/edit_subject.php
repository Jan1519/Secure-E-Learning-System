...
<?php $get_id = $_GET['id']; ?>
	...
	<?php include('navbar.php'); ?>
		...
		<!-- block -->
			...
			mysqli_query($con,"update subject set subject_code = '$subject_code' ,subject_title = '$title',unit  = '$unit',description = '$description'where subject_id = '$get_id' ")or die(mysqli_error($con));
			...
			?>
                            <script>window.location = "subjects.php";</script>
                        <?php
                        }
                        ?>
                    </div>
